                ...
                <div class="col-lg-12">
                    <div class="serviceBox">
                        ...
                        <div class="servTrans">
                            ...
                            <b>от 12 500 Руб.</b> <a data-toggle="modal" href="#request"
                                                     class="servBuy">Заказать</a><br>
                            <i>Срок от 20 дней.</i>
                        </div>
                    </div>
                    <div class="serviceBox">
                        ...
                        <div class="servTransTop">
                            ...
                            <b>от 10 000 руб.</b> <a data-toggle="modal" href="#request"
                                                     class="servBuy">Заказать</a><br>
                            <i>Срок от 15 дней.</i>
                        </div>
                        <div class="servTrans">
                            <h3>Продвижение групп.</h3>
                            <b>от 10 000 Руб./мес.</b> <a data-toggle="modal" href="#request"
                                                          class="servBuy">Заказать</a><br>
                            <i>Срок от 15 дней.</i>
                        </div>
                    </div>
                    ...
                    <div class="serviceBox">
                        ...
                        <div class="servTransTop">
                            ...
                            <b>от 12 500 Р/мес.</b> <a href="#port" class="servPortfolio smoothScroll">Смотреть
                                портфолио</a><br>
                    ...
                    <div class="serviceBox">
                        ...
                        <div class="servTrans">
                            ...
                            <b>От 5 000 Руб./мес.</b> <a data-toggle="modal" href="#request"
                                                         class="servBuy">Заказать</a><br>
                        </div>
                    </div>
                </div>
                ...
                <div class="allTeam">
                    ...
                    <div class="row">
                        <div class="teamLine  temLine2">
                            <div class="teamMember">
                                <img src="<?php bloginfo('template_directory'); ?>/img/l21-1.png"
                    ...
                    <div class="row">
                        <div class="teamLine">
                            <div class="teamMember">
                                <img src="<?php bloginfo('template_directory'); ?>/img/teamLine4.png"
                                     alt="placeholder+image">
